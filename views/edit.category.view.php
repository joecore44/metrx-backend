               ...
               <div class="form-row">
                <div class="form-group col-12 col-lg-12">
                  <div class="block col-md-12">
                    ...
                    <button class="btn btn-danger deleteItem" type="button" data-url="../controller/delete_category.php?id=<?php echo $category['category_id']; ?>" data-redirect="../controller/categorys.php"><?php echo _DELETEITEM; ?></button>
