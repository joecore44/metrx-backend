                ...
                <div class="form-row">
                  <div class="form-group col-12 col-lg-12">
                    <div class="block col-md-12">
                      ...
                      <input type="text" placeholder="" name="bodypart_title" class="form-control" required="">
                      ...
                      <input type="file" name="bodypart_image" accept=".jpg, .jpeg, .png, .gif" id="image-upload" required="" />
                      </div>
