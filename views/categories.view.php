...
<script type="text/javascript">
  $(document).ready(function(){
    $('#table_id').dataTable({
     ...
     "iDisplayLength": 10,
     "aoColumns": [
     { mData: 'category_id', "width": "5%", "className": "text-center" },
     { "mData": null , "width": "12%", "className": "product text-center",
     "mRender" : function (data) {
      return "<img src='"+IMAGES_FOLDER+data.category_image+"' class='product-img product-img-vertical'/>";}
    },
    { mData: 'category_title'},
    ...
    'searchable': false,
    "mRender" : function (data) {
      return "<a class='btn btn-small btn-primary' href='../controller/edit_category.php?id="+data.category_id+"'>"+EDITITEM+"</a> <a class='btn btn-small btn-danger btn-delete deleteItem' data-url='../controller/delete_category.php?id="+data.category_id+"'>"+DELETEITEM+"</a>";}
    }
    ]
  });
  });
    ...
    <div class="content sm-gutter">
      <div class="container-fluid padding-25 sm-padding-10">
        ...
        <div class="section-title">
          <h5><?php echo _CATEGORIES; ?></h5>
        </div>

        <div class="row">

          <div class="col-12 c-col-12">
            <a class="btn btn-primary" href="../controller/new_category.php">
