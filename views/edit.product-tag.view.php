               ...
               <div class="form-row">
                <div class="form-group col-12 col-lg-12">
                  <div class="block col-md-12">
                    ...
                    <button class="btn btn-danger deleteItem" type="button" data-url="../controller/delete_product_tag.php?id=<?php echo $tag['tag_id']; ?>" data-redirect="../controller/tags.php"><?php echo _DELETEITEM; ?></button>
