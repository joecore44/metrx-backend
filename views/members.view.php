...
<script type="text/javascript">
  $(document).ready(function(){
    $('#table_id').dataTable({
     "bProcessing": true,
     "sAjaxSource": "../controller/get_members.php",
     "responsive": true,
     "bPaginate":true,
     ...
     "aaSorting": [[1,'desc']],
     "aoColumns": [
     { mData: 'member_id', "width": "5%", "className": "text-center" },
     { mData: 'member_name'},
     { mData: 'member_email'},
  ...
  'searchable': false,
  "mRender" : function (data) {
    return "<a class='btn btn-small btn-info' href='../controller/member_details.php?id="+data.member_id+"'>"+VIEWITEM+"</a> <a class='btn btn-small btn-primary' href='../controller/edit_member.php?id="+data.member_id+"'>"+EDITITEM+"</a> <a class='btn btn-small btn-danger btn-delete deleteItem' data-msg='"+ST_BYDELETINGTHEUSER+"' data-url='../controller/delete_member.php?id="+data.member_id+"'>"+DELETEITEM+"</a>";}
  }
  ]
});
  });
      ...
      <div class="container-fluid padding-25 sm-padding-10">
        ...
        <div class="row">
          ...
          <a class="btn btn-primary" href="../controller/roles.php">
            ...
            <a class="btn btn-primary" href="../controller/new_member.php">
