            ...
            <div class="form-block mb-4">
              ...
              <form enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                ...
                <div class="form-row">
                  <div class="form-group col-12 col-lg-12">
                    <div class="block col-md-12">
                      ...
                      <input type="text" placeholder="" name="post_title" class="form-control" required="">

                      <label><?php echo _TABLEFIELDDESCRIPTION; ?></label>
                      <textarea type="text" class="simpletinymce form-control" name="post_description"></textarea>
                      
                      <label><?php echo _TABLEFIELDAVAILABILITY; ?></label>
                      <select class="custom-select form-control" name="post_availability">
                ...
                <div class="new-image" id="image-preview">
                  ...
                  <input type="file" name="post_image" accept=".jpg, .jpeg, .png, .gif" id="image-upload" required />
                </div>
