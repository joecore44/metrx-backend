        ...
        <div class="row">
          ...
          <?php endif; ?>
            ...
            <div class="form-block mb-4">
              ...
              <form enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>?id=<?php echo $level['level_id']; ?>" method="post">
               ...
               <div class="form-row">
                <div class="form-group col-12 col-lg-12">
                  <div class="block col-md-12">
                    ...
                    <input type="text" value="<?php echo $level['level_title']; ?>" name="level_title" class="form-control">

                    <label><?php echo _TABLEFIELDSTATUS; ?></label>

                    <select class="custom-select form-control" name="level_status">
                    ...
                    <div class="new-image" id="image-preview" style="background: url(<?php echo $target_dir; ?><?php echo $level['level_image'] ?>);">
                      ...
                      <input type="file" name="level_image" accept=".jpg, .jpeg, .png, .gif" id="image-upload" />
                    </div>
                    ...
                    <button class="btn btn-danger deleteItem" type="button" data-url="../controller/delete_level.php?id=<?php echo $level['level_id']; ?>" data-redirect="../controller/levels.php"><?php echo _DELETEITEM; ?></button>
