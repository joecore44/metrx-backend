        ...
        <div class="row">
          ...
          <?php endif; ?>
            ...
            <div class="form-block mb-4">
              ...
              <form enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>?id=<?php echo $goal['goal_id']; ?>" method="post">
               ...
               <div class="form-row">
                <div class="form-group col-12 col-lg-12">
                  <div class="block col-md-12">
                    ...
                    <input type="text" value="<?php echo $goal['goal_title']; ?>" name="goal_title" class="form-control">

                    <label><?php echo _TABLEFIELDSTATUS; ?></label>

                    <select class="custom-select form-control" name="goal_status">
                    ...
                    <div class="new-image" id="image-preview" style="background: url(<?php echo $target_dir; ?><?php echo $goal['goal_image'] ?>);">
                      ...
                      <input type="file" name="goal_image" accept=".jpg, .jpeg, .png, .gif" id="image-upload" />
                    </div>
                    ...
                    <button class="btn btn-danger deleteItem" type="button" data-url="../controller/delete_goal.php?id=<?php echo $goal['goal_id']; ?>" data-redirect="../controller/goals.php"><?php echo _DELETEITEM; ?></button>
