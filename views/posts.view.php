...
<script type="text/javascript">
  $(document).ready(function(){
    $('#table_id').dataTable({
     "bProcessing": true,
     "sAjaxSource": "../controller/get_posts.php",
     "responsive": true,
     "bPaginate":true,
     "aaSorting": [[1,'desc']],
     ...
     "mRender" : function (data) {
      return "<img src='"+IMAGES_FOLDER+data.post_image+"' class='product-img product-img-vertical'/>";}
    },
    { mData: 'post_title'},
    { mData: 'member_name'},
    { "mData": null , "width": "5%", "className":"text-capitalize",
     "mRender" : function (data) {
      return '<span>'+data.post_availability+'</span>';
      }
    },
    ...
    'searchable': false,
    "mRender" : function (data) {
      return "<a class='btn btn-small btn-primary' href='../controller/edit_post.php?id="+data.post_id+"'>"+EDITITEM+"</a> <a class='btn btn-small btn-danger btn-delete deleteItem' data-url='../controller/delete_post.php?id="+data.post_id+"'>"+DELETEITEM+"</a>";}
    }
    ]
  });
  });
    ...
    <div class="content sm-gutter">
      <div class="container-fluid padding-25 sm-padding-10">
        ...
        <div class="row">
          ...
          <a class="btn btn-primary" href="../controller/tags.php">
              <i class="fa fa-tag add-new-i"></i> <?php echo _TAGS; ?>
            </a>
