              ...
              <form enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                <div class="form-row">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input type="text" value="" placeholder="" name="member_name" class="form-control" required="">

                    <label class="required"><?php echo _TABLEFIELDUSEREMAIL; ?></label>
                    <input type="email" value="" placeholder="" name="member_email" class="form-control" required="">

                    <label class="required"><?php echo _TABLEFIELDPASSWORD; ?></label>
                    <input type="password" value="" placeholder="" name="member_password" class="form-control" id="password-field" required="">
                    <span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password"></span>

                    <label class="required"><?php echo _TABLEFIELDUSERROLE; ?></label>
                    <select class="custom-select form-control" name="member_role" required="">
