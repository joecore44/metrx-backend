...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    { "mData": null , "width": "5%", "className":"text-capitalize",
     "mRender" : function (data) {
      return '<span>'+data.workout_availability+'</span>';
      }
    },
    { mData: 'member_name'},
    { mData: 'trainer_name'},
    ...
    'searchable': false,
    "mRender" : function (data) {
      return "<a class='btn btn-small btn-primary' href='../controller/edit_workout.php?id="+data.workout_id+"'>"+EDITITEM+"</a> <a class='btn btn-small btn-danger btn-delete deleteItem' data-url='../controller/delete_workout.php?id="+data.workout_id+"'>"+DELETEITEM+"</a>";}
    }
    ]
  });
  });
      ...
      <div class="container-fluid padding-25 sm-padding-10">
        ...
        <div class="row">
          ...
          <div class="col-12 c-col-12">
            ...
            <a class="btn btn-primary" href="../controller/new_workout.php">
