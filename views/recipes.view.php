  ...
  $(document).ready(function(){
    $('#table_id').dataTable({
     ...
     "mRender" : function (data) {
      return "<img src='"+IMAGES_FOLDER+data.recipe_image+"' class='product-img product-img-vertical'/>";}
    },
    { mData: 'recipe_title'},
    { mData: 'member_name'},
    { "mData": null , "width": "5%", "className":"text-capitalize",
     "mRender" : function (data) {
      return '<span>'+data.recipe_availability+'</span>';
      }
    },
    { "mData": null , "width": "10%", "className":"status text-center",
     "mRender" : function (data) {
      if (data.recipe_featured == 1) {
      ...
      <div class="container-fluid padding-25 sm-padding-10">
        ...
        <div class="row">
          ...
          <div class="col-12 c-col-12">
            ...
            <a class="btn btn-primary" href="../controller/categories.php">
              <i class="fa fa-folder add-new-i"></i> <?php echo _CATEGORIES; ?>
            </a>
