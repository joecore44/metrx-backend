                ...
                <div class="form-row">
                  <div class="form-group col-12 col-lg-12">
                    ...
                    <select class="selectDrop form-control" name="trainer_member">
                      ...
                      <input type="text" placeholder="" name="trainer_name" class="form-control" required="">

                      <label><?php echo _TABLEFIELDDESCRIPTION; ?></label>
                      <textarea type="text" class="form-control" name="trainer_description"></textarea>
                      ...
                      <div class="new-image" id="image-preview">
                        <label class="required" for="image-upload" id="image-label"><?php echo _CHOOSEFILE; ?></label>
                        <input type="file" name="trainer_avatar" accept=".jpg, .jpeg, .png, .gif" id="image-upload" required/>
                      </div>
