                    ...
                    <div class="login-div">
                       <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" name="login" id="needs-validation" novalidate>  
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control input-lg" placeholder="<?php echo _LOGINUSERNAME; ?>" name="member_email" type="text" required>
                                <div class="invalid-feedback"><?php echo _LOGINREQUIREDFORM; ?></div>
                            </div>
                            <div class="form-group">
                                <label><?php echo _LOGINPASSWORD; ?></label>
                                <input class="form-control input-lg" placeholder="<?php echo _LOGINPASSWORD; ?>" name="member_password" type="password" required>
                                <div class="invalid-feedback"><?php echo _LOGINREQUIREDFORM; ?></div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" class="form-control input-lg" placeholder="<?php echo _LOGINPCAPTCHA; ?>" name="captcha" required>
                                    <div class="invalid-feedback"><?php echo _LOGINREQUIREDFORM; ?></div>
                                </div>
                                <div class="form-group col-6">
                                    <label><?php echo _LOGINPCAPTCHACODE; ?></label>
                                    <img src="../controller/captcha.php" style="width: 100%; border-radius: 4px; height: 46px;">
                                </div>
                            </div>

                            <button class="btn btn-primary mt-2 btn-lg" type="submit" style="width: 100%"><?php echo _LOGINBUTTON; ?></button>
