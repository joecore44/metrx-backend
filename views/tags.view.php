...
<script type="text/javascript">
  $(document).ready(function(){
    $('#table_id').dataTable({
     "bProcessing": true,
     "sAjaxSource": "../controller/get_tags.php",
     "responsive": true,
     "bPaginate":true,
     "aaSorting": [[1,'desc']],
    ...
    'searchable': false,
    "mRender" : function (data) {
      return "<a class='btn btn-small btn-primary' href='../controller/edit_tag.php?id="+data.tag_id+"'>"+EDITITEM+"</a> <a class='btn btn-small btn-danger btn-delete deleteItem' data-url='../controller/delete_tag.php?id="+data.tag_id+"'>"+DELETEITEM+"</a>";}
    }
    ]
  });
  });
      ...
      <div class="container-fluid padding-25 sm-padding-10">
        ...
        <div class="row">
          ...
          <div class="col-12 c-col-12">
            <a class="btn btn-primary" href="../controller/new_tag.php">
