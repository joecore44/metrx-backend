...
if(check_permission('view_roles') || check_permission('edit_roles')){
	...
	$role_permissions = (!empty($_POST['role_permissions']) && isset($_POST['role_permissions']) ? json_encode($_POST['role_permissions']) : "");
	...
	$role_permissions_array = (!empty($role['role_permissions']) && isset($role['role_permissions']) ? $role['role_permissions'] : "[]");
